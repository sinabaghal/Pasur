...
\scalebox{0.5}{
    \begin{tikzpicture}
        ...
        \node[rotate=0] at (-2, -4) {\Large Hyper-node Tree}; 
        \node[rotate=0] at (11, -4) {\Large Complete Tree}; 
 \draw[->, very thick, decorate, decoration={snake, amplitude=2mm, segment length=5mm}] (2.5cm, -9cm) -- (4.5cm, -9cm);
        \node[rotate=0] at (3.5, -8) {\Large Unfold w/}; 
        \node[rotate=0] at (3.5, -10) {\Large Ext. Sampling};
...
\caption{An illustration of how \py{t\_edg} is constructed under ex. sampling regime.}
    \label{fig:tedge}
\end{figure}